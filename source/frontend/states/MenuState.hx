...
import frontend.objects.menu.Profile;
...
class MenuState extends StateBase {
	...
	var options:Array<Dynamic> = [
		["options", () -> trace("wawer")],
		["play", () -> Common.switchState(new frontend.states.debug.MenuDebugState())],
		["edit", () -> trace("wawer")],
        ["debug-holds", () -> Common.switchState(new frontend.states.debug.TestingState())]
	];
